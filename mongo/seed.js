...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Connececting to ".concat(process.env.DATABASE_URL, "..."));
                    return [4 /*yield*/, mongodb_1.MongoClient.connect(process.env.DATABASE_URL)];
                case 1:
                    client = _a.sent();
                ...
                case 7:
                    ...
                    return [4 /*yield*/, db.collection('accounts').insertOne({
